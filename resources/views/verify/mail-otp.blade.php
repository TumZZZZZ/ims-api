        ...
        <tr>
            <td align="center" valign="middle" style="padding:40px 10px;">
                <table role="presentation" class="email-container" width="420" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td
                            style="background:#FFC0CB;padding:16px;text-align:center;color:#ffffff;font-size:17px;font-weight:bold;border-radius:8px 8px 0 0;">
                            {{ $app_name }}
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:24px 28px;text-align:center;color:#333333;font-size:15px;line-height:1.5;">
                            <p style="margin:0 0 16px 0;">Use this code to verify your identity and reset your password.
                            </p>
                            <div
                                style="display:inline-block;background:#f3f4f6;border:1px solid #e5e7eb;border-radius:6px;padding:12px 24px;font-size:26px;font-weight:bold;letter-spacing:4px;color:#111827;">
                                {{ $otp }}
                            </div>
